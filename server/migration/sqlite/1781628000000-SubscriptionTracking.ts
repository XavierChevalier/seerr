...
export class SubscriptionTracking1781628000000 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE TABLE "subscription_payment" ("id" integer PRIMARY KEY AUTOINCREMENT NOT NULL, "date" date NOT NULL, "amount" decimal(10,2) NOT NULL, "method" varchar NOT NULL, "userId" integer, CONSTRAINT "FK_2a17e8d0eea74a5607de6aa549a" FOREIGN KEY ("userId") REFERENCES "user" ("id") ON DELETE CASCADE ON UPDATE NO ACTION)`
    );
    await queryRunner.query(
      `CREATE TABLE "subscription_gift" ("id" integer PRIMARY KEY AUTOINCREMENT NOT NULL, "date" date NOT NULL, "months" integer NOT NULL, "reason" varchar NOT NULL, "userId" integer, CONSTRAINT "FK_a4783a9809ec251659127e3deb9" FOREIGN KEY ("userId") REFERENCES "user" ("id") ON DELETE CASCADE ON UPDATE NO ACTION)`
    );
    await queryRunner.query(
